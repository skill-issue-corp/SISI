...
trait-language-raiderspeak-name = Набегаторский
trait-language-raiderspeak-desc = Древний и надёжный язык, на котором в основном говорят набегеры. У обладателей щита разума не может быть этого языка.
