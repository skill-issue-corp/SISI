    ...
    На данный момент мейнтейнеры сталкиваются с большим количеством накопившихся заявок и,
    к сожалению, не могут рассмотреть каждый pull request.
    Поскольку этот PR касается добавления нового контента и/или изменений баланса,
    признанных малозначимыми, мы решили закрыть его вместо того, чтобы оставлять открытым бесконечно.
    PR могут быть открыты заново в будущем, когда очередь сократится,
    и мы призываем вас продолжать вносить вклад в другие части кодовой базы.
...
end-round-credits-inky-16 = "твоё объяснение просто отстой. Стоит намного больше, чем это,
    чтобы попытаться в одиночку финансировать компанию антагонистов."
    ...
    NT отстой, и никто им не пользуется, но вам тоже не стоит им пользоваться,
    потому что он разрушает окружающую среду!!!
...
end-round-credits-shoutout-inky-9 = Bug Reporters
end-round-credits-shoutout-inky-10 = Wizden Contributors
end-round-credits-shoutout-inky-11 = Trauma Contributors
end-round-credits-shoutout-inky-12 = Goob Contributors
end-round-credits-shoutout-inky-13 = Inky Contributors
end-round-credits-shoutout-inky-14 = Polaks
