...
salv-job-board-name-BountySalvageOreBananium = Бananиум (Руда)
...
# Trauma - plasma -> phoron
bounty-description-salvage-ore-plasma = Нам нужна партия форон-руды для отправки на исследовательскую станцию. Пожалуйста, предоставьте нам её, чтобы мы могли продолжить наши испытания. Она может быть любого происхождения.
