...
abductor-role-greeting = Вы — профессиональный боевой учёный высокотехнологичной расы. Ваша задача — похищать людей, проводить над ними эксперименты, и возвращать живыми ради чистоты эксперимента. Вам невыгодно уничтожать станцию, убивать или помогать экипажу.
