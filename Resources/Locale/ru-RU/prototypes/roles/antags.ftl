...
roles-antag-syndicate-agent-name = Предатель
...
## Goob - replaced Syndicate agent with Traitor
roles-antag-syndicate-agent-sleeper-objective = Разновидность предателя, который может активироваться в любой момент смены.
...
roles-antag-nuclear-operative-agent-objective = Медик отряда ядерных оперативников. Ведите свой отряд к победе с помощью медицины!
