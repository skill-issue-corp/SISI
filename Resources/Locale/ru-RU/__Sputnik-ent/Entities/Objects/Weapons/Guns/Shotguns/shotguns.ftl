...
ent-WeaponShotgunHushpup = Hushpup
    .desc = Малоизвестная модификация Силовика, оснащённая экспериментальным глушителем. Отлично подходит для тех, кто придерживается строгого морального кодекса. Использует патроны 12 калибра.
