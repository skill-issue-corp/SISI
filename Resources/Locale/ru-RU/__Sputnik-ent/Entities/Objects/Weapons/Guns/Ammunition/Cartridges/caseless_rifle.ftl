ent-BaseCartridgeCaselessRifle = cartridge (9.5mm)
    .desc = { ent-BaseCartridge.desc }

ent-CartridgeCaselessRifle = cartridge (9.5mm HP)
...
ent-CartridgeCaselessRiflePractice = cartridge (9.5mm practice)
