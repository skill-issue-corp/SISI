...
ent-CrateFunInstrumentsRandom = ящик со случайной коллекцией инструментов
    .desc = Коробка, содержащая несколько случайно подобранных инструментов, выбранных вручную лучшими музыкантами ЦентКома!
