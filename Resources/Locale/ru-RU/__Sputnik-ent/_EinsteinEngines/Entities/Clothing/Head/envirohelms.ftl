ent-ClothingHeadEnvirohelm = фороновый экошлем скафандра
    .desc = Специальный герметичный шлем, позволяющий фороновым формам жизни безопасно существовать в среде с кислородом.
