...
ent-ClothingModsuitHelmetCorporate = корпоративный шлем модкостюма
    .desc = Современный шлем, разработанный компанией «NanoTrasen» для корпоративного модкостюма. Оснащён встроенным ХУДом.
ent-ClothingModsuitChestplateCorporate = корпоративный нагрудник модкостюма
    .desc = Современный нагрудник, разработанный компанией «NanoTrasen» для корпоративного модкостюма. Оснащён моторизированными сервоприводами для снижения нагрузки от экипировки.
