...
ent-EscapeThiefShuttleObjective = Сбежать живым и не связанным на спасательном шаттле в ЦентКом.
    .desc = Вы же не хотите, чтобы кто-то узнал о вашей незаконной деятельности?
