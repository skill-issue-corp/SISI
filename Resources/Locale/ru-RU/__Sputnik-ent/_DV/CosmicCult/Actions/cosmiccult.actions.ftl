...
ent-ActionCosmicFragmentation = Нулевая фрагментация
    .desc = Перенесите ваше зловещее могущество в цифровую систему, например в консоль загрузки ИИ или киборга, повреждая её в процессе.
...
ent-ActionCosmicTransmutation = Осквернить материю
    .desc = Наполните удерживаемый предмет зловещей силой, превращая его во что-то иное.
...
ent-ActionCosmicColossusSunder = Энтропийный разлом
    .desc = Переместитесь в указанное место и высвободите ударную волну зловещей энергии.
