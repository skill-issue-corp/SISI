...
ent-RevTelesphere = телесфера
    .desc = Экспериментальное устройство, может использоваться для удалённой кражи материалов с проходящих торговых кораблей с помощью форона. Кроме того, может использоваться как хранилище материалов для революции.
...
ent-RevTechAnalyzer = анализатор технологий
    .desc = Сканирует технологии NT и производит технодиски для создания сборщиком микроэлектроники.

ent-RevPlasmaFoundry = фороновый горн
    .desc = Продвинутый горн, работающий на листах форона, невероятно быстро плавит металлы и производит продвинутые компоненты.
