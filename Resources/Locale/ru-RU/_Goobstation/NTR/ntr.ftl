...
ntr-executive-eva-crate-name = Набор EVA
ntr-executive-eva-crate-desc = Ящик с двумя аварийными EVA, которые помогут вам и вашим людям выжить в катастрофической ситуации.
...
ntr-executive-softsuit-name = Заказать базовый EVA
ntr-executive-softsuit-desc = Базовый EVA, предназначенный для кратковременного пребывания в космосе. Обеспечивает минимальную защиту.
ntr-executive-hardsuit-name = Заказать EVA
ntr-executive-hardsuit-desc = Прочный EVA для экстремальных условий. Вы уверены, что эта покупка оправдана?
