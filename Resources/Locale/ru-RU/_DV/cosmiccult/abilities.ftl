...
cosmicability-monument-move-confirm = ЭТО ДЕЙСТВИЕ МОЖНО ИСПОЛЬЗОВАТЬ ТОЛЬКО РАЗ В 10 МИНУТ! Используйте снова для подтверждения.
cosmicability-monument-spawn-confirm = ЭТО ДЕЙСТВИЕ МОЖНО ИСПОЛЬЗОВАТЬ ТОЛЬКО ОДИН РАЗ! Используйте снова для подтверждения.
cosmicability-monument-spawn-error-grid = Недопустимое место! Монумент должен быть призван на устойчивой поверхности.
