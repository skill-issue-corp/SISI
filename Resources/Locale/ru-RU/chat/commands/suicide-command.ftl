...
suicide-command-help-text = Команда самоубийства даёт вам быстрый способ выйти из раунда, оставаясь в характере.
                            Способ варьируется: сначала будет предпринята попытка использовать предмет в вашей активной руке.
