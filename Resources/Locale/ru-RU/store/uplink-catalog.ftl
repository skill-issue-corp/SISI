...
uplink-pistol-cobra-desc = Надёжный, робастный пистолет оперативника со встроенным глушителем. Использует патроны 9.5 мм безгильзовые магнум, поставляется с магазином экспансивных патронов.
...
uplink-esword-double-desc = Немного более дорогой энергетический меч с большим акцентом на полезность. Наносит примерно такой же урон, но гораздо точнее отражает энергетические снаряды. Сильно шумит при использовании или включении.
...
uplink-hushpup-desc = Мощный дробовик с глушителем и малой ёмкостью магазина. Использует патроны 12 калибра.

uplink-c20r-name = C-20r
uplink-c20r-desc = Старый добрый: классический пистолет-пулемёт C-20r.

uplink-bulldog-name = Бульдог
uplink-bulldog-desc = Просто и надёжно: содержит популярный дробовик "Бульдог".

uplink-grenade-launcher-name = China-Lake
uplink-grenade-launcher-desc = Старый гранатомёт China-Lake, в комплекте с 5 противопехотными гранатами.
...
uplink-penguin-grenade-desc = Маленький, крайне агрессивный пингвин с гранатой, закреплённой на шее. Обучен игнорировать всех агентов Синдиката и неотступно преследовать одну случайную ближайшую цель после высвобождения.

uplink-c4-name = C-4
uplink-c4-desc = Используйте её, чтобы разрушать стены, шлюзы или саботировать оборудование. Её можно прикрепить практически к любому объекту, а таймер можно изменять, минимальное значение - 10 секунд. Оснащена ИИ.
...
uplink-exploding-syndicate-bomb-desc = Большая, закрепляемая на месте бомба, которая произведёт мощный взрыв, если её вовремя не обезвредить. Полезна в качестве отвлечения внимания. Имеет регулируемый таймер взрыва с минимальной и базовой настройкой в 60 секунд.
...
uplink-pistol-magazine-desc = Пистолетный магазин на 12 патронов. Совместим с "Гадюкой".
...
uplink-magazine-bulldog-pellet-name = Барабанный магазин (12 калибр)
uplink-magazine-bulldog-pellet-desc = Магазин дробовика на 8 патронов с картечью. Совместим с "Бульдогом".

uplink-magazine-bulldog-slug-name = Барабанный магазин (12 калибр)
uplink-magazine-bulldog-slug-desc = Магазин дробовика на 8 патронов с пулями. Совместим с "Бульдогом".
...
uplink-pistol-magazine-caseless-name = Пистолетный магазин (9.5 мм экспансивные)
uplink-pistol-magazine-caseless-desc = Пистолетный магазин на 10 безгильзовых экспансивных патронов. Совместим с "Коброй".
...
uplink-holopara-kit-desc =
    ...
    Страж может наносить быстрые удары, невосприимчив к опасностям атмосферы и устойчив к механическому урону, но разделяет получаемые повреждения с хозяином. Не может быть использован Чужими.
...
uplink-syndicate-id-card-desc = ID-карта Синдиката с доступом Синдиката. Вряд ли будет полезна сама по себе, но отлично подойдёт для перенастроенных дверей. Не обладает функцией копирования доступа.
...
uplink-radio-jammer-desc = Это устройство блокирует любую исходящую поблизости радиосвязь и датчики комбинезонов при активации.

uplink-syndicate-weapon-module-name = Оружейный модуль борга
uplink-syndicate-weapon-module-desc = Модернизирует борга, добавляя энергетический кинжал и перезаряжаемый пистолет.
...
uplink-syndimov-law-desc = Подрывной набор законов, который стоит использовать, если вы хотите переманить ИИ на свою сторону — применяйте как можно чаще. Поставляется с ID-картой Синдиката.
...
uplink-freedom-implanter-desc = Сбегите от этих противных сотрудников СБ при помощи этого импланта! Он позволяет легко освобождаться от наручников и бол, а также парализовать любого, кто осмелится тащить вас.
...
uplink-voice-mask-implanter-desc = Изменяет ваши голосовые связки и черты лица, позволяя имитировать кого угодно, кого только можно представить.
...
uplink-chemistry-kit-desc = Стартовый набор начинающего химика, включающий химический заряд с таймером, шприц гиперзина и две пробирки вестина для всех ваших преступных нужд!

uplink-knives-kit-name = Набор метательных ножей
uplink-knives-kit-desc = Набор из 8 фирменных метательных ножей Синдиката, идеально подходящих для вонзания в тело жертвы. При броске полностью игнорируют броню.
...
uplink-ammo-bundle-desc = Перезаряжаю! Содержит 4 магазина для C-20r, 4 барабана для "Бульдога", 3 магазина для марксманской винтовки "Эсток" и 2 короба патронов для L6 SAW.

uplink-sniper-bundle-name = Набор снайпера
uplink-sniper-bundle-desc = Неприметный чемодан, в котором находятся "Христов", 15 запасных патронов и удобная маскировка.
...
uplink-bulldog-bundle-desc = Просто и надёжно: содержит популярный дробовик "Бульдог", барабан с пулями 12 калибра и четыре барабана с картечью 12 калибра.
...
uplink-starter-kit-desc = Содержит всё необходимое для начала работы оперативника. Для тех, кто просто не знает, что купить.
...
uplink-syndicate-jaws-of-life-desc = Комбинированный инструмент для вскрытия и резки. Полезен для проникновения на станцию или в её отделы. Может открывать даже заблокированные двери!
...
uplink-cane-blade-desc = Трость со спрятанным странным клинком, который можно обнажить в любой момент. Украдена из личного музея куратора. Поджигает людей благодаря древним чарам.

# Armor
uplink-chameleon-name = Набор "Хамелеон"
uplink-chameleon-desc = Рюкзак, полный вещей, оснащённых технологией хамелеона, позволяющих вам маскироваться под кого угодно на станции, и даже больше! В комплекте бесплатная ID-карта агента!
...
uplink-clothing-outer-vest-web-elite-desc = Синтетический бронежилет. Имеет дополнительные ремни и термостойкие волокна.
...
uplink-eva-syndie-desc = EVA-скафандр из дуранити с некоторой защитой и встроенной защитой от радиации. Очень манёвренный, не создаёт замедления.
...
uplink-eshield-desc = Экзотический энергощит, отражающий все лазерные лучи и обеспечивающий небольшую защиту от пуль и других физических атак. Разряжается при получении урона и способен автоматически перезаряжаться. Внимание: ЭМИ-импульсы способны разрядить внутреннюю батарею энергощита.
...
uplink-stimpack-desc = Легендарный химический коктейль, производимый компанией Donk Co. для Синдиката. Одна инъекция этого вещества увеличивает скорость бега и позволяет быстрее восстанавливаться после оглушения в течение 40 секунд.

uplink-stimkit-name = Набор инъекторов гиперзина
uplink-stimkit-desc = Аптечка, содержащая 8 микроинъекторов гиперзина, каждый из которых содержит дозу гиперзина на 20 секунд.
...
uplink-chameleon-projector-desc = Исчезните из поля зрения, создав вокруг себя голограмму какого-либо предмета. Не используйте его для игры «Поиск предметов».
...
uplink-briefcase-gun-name = Пистолет-чемодан
uplink-briefcase-gun-desc = Неприметный чемодан с компактно установленным внутри C-20K. Осторожно, не сжимайте ручку слишком сильно!

uplink-energycrossbow-name = Мини-энергетический арбалет
uplink-energycrossbow-desc = Излюбленное дополнительное оружие оперативников, предпочитающих неподвижных жертв. Стреляет самовосстанавливающимися токсичными стрелами, мгновенно валящими жертву с ног.

#Objective items
uplink-hijack-beacon-name = Маяк захвата
uplink-hijack-beacon-desc = Маяк захвата производства Синдиката, предназначенный для обхода файрволов автоматических торговых станций производства Nanotrasen. Взлом занимает 200 секунд, и торговая станция объявит о попытке взлома, так что готовьтесь заранее.
