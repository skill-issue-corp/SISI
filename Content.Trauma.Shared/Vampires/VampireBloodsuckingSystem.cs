...
public sealed partial class VampireBloodsuckingSystem : EntitySystem
{
    ...
    private void OnMeleeHit(Entity<VampireBloodsuckingComponent> ent, ref MeleeHitEvent args)
    {
        ...
        {
            _popup.PopupEntity("Эту цель нельзя высосать!", ent.Owner, PopupType.MediumCaution); // SIS-TODO: Анхаркод локали
            return;
        }
    ...
    private void OnBloodSuckDoAfter(Entity<VampireBloodsuckingComponent> ent, ref BloodSuckDoAfterEvent args)
    {
        ...
        {
            _popup.PopupEntity("Их кровь бледна...", user, user, PopupType.MediumCaution); // SIS-TODO: Анхаркод локали
            return;
        }
        ...
        {
            _popup.PopupEntity("Вы высосали большую часть их жизненной силы, вы больше не получите от них пригодной для использования крови", user, user, PopupType.MediumCaution); // SIS-TODO: Анхаркод локали
            return;
        }
        ...
        _popup.PopupEntity("Вы высасываете из них жизненную силу...", user, user, PopupType.MediumCaution); // SIS-TODO: Анхаркод локали
        _popup.PopupEntity("Вы чувствуете, будто из вас высосали жизненную силу...", user, target, PopupType.MediumCaution); // SIS-TODO: Анхаркод локали
    ...
    private void BloodSuck(Entity<VampireBloodsuckingComponent> ent, EntityUid target)
    {
        ...
        _popup.PopupEntity("Вы начинаете высасывать их...", ent.Owner, ent.Owner, PopupType.Medium); // SIS-TODO: Анхаркод локали
        ...
        {
            _popup.PopupEntity("Процесс высасывания крови провалился!", ent.Owner, ent.Owner, PopupType.SmallCaution); // SIS-TODO: Анхаркод локали
            Dirty(ent);
        }
    }
    #endregion
