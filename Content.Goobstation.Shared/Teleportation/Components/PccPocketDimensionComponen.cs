...
/// </summary>
[RegisterComponent, NetworkedComponent, Access(typeof(PccPocketDimensionSystem))]
[AutoGenerateComponentState]
public sealed partial class PccPocketDimensionComponent : Component
{
    /// <summary>
    ...
    /// </summary>
    [DataField, AutoNetworkedField]
    public EntityUid? PccPocketDimensionMap;

    /// <summary>
    /// The first grid found on <see cref="PccPocketDimensionMap"/>.
    /// </summary>
    [DataField, AutoNetworkedField]
    ...
    /// </summary>
    [DataField]
    public ResPath PccPocketDimensionPath = new ResPath("/Maps/_Goobstation/Nonstations/pcc-pocket-dimension.yml");
